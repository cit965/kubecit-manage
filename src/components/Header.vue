      ...
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="h-8 w-auto" src="https://avatars.githubusercontent.com/u/49775493?v=4" alt="" />
          </a>
        </div>
        ...
        <PopoverGroup class="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900"><RouterLink to="/about">分类</RouterLink></a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900"><RouterLink to="/">课程</RouterLink></a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900">设置</a>
        </PopoverGroup>
