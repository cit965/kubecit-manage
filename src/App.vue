  ...
  <header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900"><RouterLink to="/about">Features</RouterLink></a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900"><RouterLink to="/">Marketplace</RouterLink></a>
